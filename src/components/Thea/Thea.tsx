      ...
      <AnimatePresence>
        {!isMinimized && !isIntroShown && mostRecentMessage && mostRecentMessage.sender === 'thea' && (
          <motion.div
            ...
            className="bg-gradient-to-br from-white/95 to-gray-100/95 dark:from-gray-800/95 dark:to-gray-900/95 p-5 rounded-xl shadow-lg border border-purple-200/50 dark:border-purple-700/30 mb-2 max-w-xs backdrop-blur-sm fixed bottom-24 right-4 z-[9998]"
          >
